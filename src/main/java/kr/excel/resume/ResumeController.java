...
public class ResumeController {
    ...
    public void createResume() {
        ...
        List<Education> educationsList = view.inputEducationList();
        List<Career> careerList = view.inputCareerList();
        String selfIntroduction = view.inputSelfIntroduction();

        createResumeSheet(personInfo, educationsList, careerList);
    ...
    private void createResumeSheet(PersonInfo personInfo, List<Education> educationsList, List<Career> careerList) {
